...
ALTER TABLE `MOVIE_TICKET` ADD FOREIGN KEY (`TICKET_SEQ`) REFERENCES `TICKETING`(`TICKET_SEQ`);
ALTER TABLE `MOVIE_TICKET` ADD FOREIGN KEY (`SCREEN_CODE`) REFERENCES `SCREEN`(`SCREEN_CODE`);
ALTER TABLE `MOVIE_TICKET` ADD FOREIGN KEY (`THEATER_CODE`) REFERENCES `THEATER`(`THEATER_CODE`);
