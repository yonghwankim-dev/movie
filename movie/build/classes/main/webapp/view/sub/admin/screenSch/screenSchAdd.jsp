...
<div id="screenSch_add_form" class="form_popup">
    <form id="screenSchFrm" class="form_container">
        ...
        <div class="form_row">
            ...
            <input id="screen_date" type="text" placeholder="2022-03-29" name="screen_date" required>
        </div>

        <div class="form_row">
            <label for="start_time"><b>시작시간</b></label>
			<input id="start_time" type="text" placeholder="12:00" name="start_time" required>
        </div>
        
        <div class="form_row">
            <label for="end_time"><b>종료시간</b></label>
			<input id="end_time" type="text" placeholder="12:00" name="end_time" required>
        </div>
        
        <div class="form_row">
            <label for="screen_num"><b>상영회차</b></label>
			<input id="screen_num" type="text" placeholder="1" name="screen_num" required>
        </div>
        
        <div class="form_row hidden">
            <label for="movie_code"><b>영화코드</b></label>
			<input id="movie_code" type="text" name="movie_code" value="${movie_code}" readonly>
        </div>
        
        <div class="form_row hidden">
            <label for="theater_code"><b>상영관코드</b></label>
			<input id="theater_code" type="text" name="theater_code" value="${theater_code}" readonly>
        </div>
        
        <div class="form_row hidden">
            <label for="screen_code"><b>상영코드</b></label>
			<input id="screen_code" type="text" name="screen_code" value="${screen_code}" readonly>
        </div>
...
$('#screenSchAddBtn').on('click', function() {
	$.ajax({
			url : '${pageContext.request.contextPath}${UrlPaths.SCREEN_SCH_ADD}',
			type : 'post',
