...
<script src="<%=request.getContextPath() %>/js/lost.js"></script>
<script>
let currentPage = 1;
      ...
      <div class="modal-body">
        <form>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" class="txt form-control" name="lost_wri" id="memWrt"><br>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" class="txt form-control" name="lost_tit" id="textNm"><br>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <textarea class="txt form-control" rows="5" cols="50" name="lost_con" id="tta"></textarea><br>
            </div>
          </div>
