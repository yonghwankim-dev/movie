      ...
      <div class="modal-body">
        <form>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" class="txt form-control" name="qna_wri" id="memWrt"><br>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" class="txt form-control" name="qna_tit" id="textNm"><br>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <textarea class="txt form-control" rows="5" cols="50" name="qna_con" id="tta"></textarea><br>
            </div>
          </div>
